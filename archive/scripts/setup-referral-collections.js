...
async function setupReferralCollections() {
  try {
    ...
    try {
      ...
      await databases.createFloatAttribute(databaseId, 'rewards_pools', 'balance', true)
      await databases.createFloatAttribute(databaseId, 'rewards_pools', 'totalDeposited', true)
      await databases.createFloatAttribute(databaseId, 'rewards_pools', 'totalDistributed', true)
      await databases.createIntegerAttribute(databaseId, 'rewards_pools', 'totalContributors', true)
