          ...
          >
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex-1 px-3 py-1.5 rounded-lg bg-gradient-to-r from-fuchsia-500 via-purple-500 to-cyan-500 text-white text-xs font-medium hover:opacity-90 transition-all focus:outline-none focus:ring-2 focus:ring-fuchsia-400/80"
              >
                Accept
              </button>
              <button
                onClick={() => onDecline(invite.id)}
                className="px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 text-white/70 hover:text-white text-xs font-medium transition-all focus:outline-none focus:ring-2 focus:ring-fuchsia-400/80"
