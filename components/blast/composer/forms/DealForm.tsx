...
export function DealForm({ onSubmit, isPending }: DealFormProps) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          placeholder="e.g., Looking for intro to Series A investors"
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="What are you looking for? Be specific about the opportunity..."
      ...
      <div className="btdemo-glass-subtle rounded-xl p-4 flex items-start gap-3 text-sm">
        ...
        <div className="text-zinc-400">
          Your deal room will be open for {duration}. Applicants will stake keys to apply.
          You can accept up to {maxSlots} participants.
        </div>
      </div>
