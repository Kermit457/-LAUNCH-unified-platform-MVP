...
export default function NavBar() {
  ...
  return (
    <nav className="bg-black/30 backdrop-blur-lg sticky top-0 z-50">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Center Navigation - Compact Pill Style */}
          <div className="hidden md:flex items-center gap-2 bg-zinc-900/60 backdrop-blur-xl px-3 py-2 rounded-full border border-zinc-800/60">
            {links.map((link) => {
              ...
              return (
                ...
                >
                  {/* Active Background */}
                  {isActive && (
                    <span className="absolute inset-0 bg-gradient-to-r from-violet-600 to-purple-600 rounded-full -z-10" />
                  )}
