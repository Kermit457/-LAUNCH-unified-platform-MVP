...
export function ClipStats({
  ...
  if (variant === 'inline') {
    return (
      <div className={cn(
        'flex items-center gap-3 px-3 py-1.5 rounded-lg bg-[#D1FD0A]/10 border border-[#D1FD0A]/20',
        className
      )}>
        <Video className="w-4 h-4 text-[#D1FD0A]" />
        <div className="flex items-center gap-2 text-xs">
          <span className="text-zinc-400">Clips:</span>
          <span className="font-bold text-[#D1FD0A]">{clipCount}</span>
  ...
  return (
    <div className={cn('space-y-2', className)}>
      <div className="flex items-center gap-2 text-sm font-medium text-[#D1FD0A]">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="text-center">
          ...
          <div className="text-lg font-bold text-[#D1FD0A]">{clipCount}</div>
        </div>
        <div className="text-center">
