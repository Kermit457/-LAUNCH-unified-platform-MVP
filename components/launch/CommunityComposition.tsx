...
export function CommunityComposition({ stats, isLoading }: CommunityCompositionProps) {
  ...
  const allRoles = [
    ...
    { id: 'influencers', label: 'Influencer', count: stats.influencers, icon: Megaphone, color: 'text-purple-400', bgColor: 'bg-purple-400/10' },
    { id: 'marketers', label: 'Marketer', count: stats.marketers, icon: Sparkles, color: 'text-fuchsia-400', bgColor: 'bg-fuchsia-400/10' },
