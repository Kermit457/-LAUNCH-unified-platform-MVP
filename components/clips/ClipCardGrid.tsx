  ...
  return (
    ...
    >
      <div className="relative aspect-[9/16] bg-gradient-to-br from-neutral-800 to-neutral-900 flex items-center justify-center">
        ...
        {/* Trending Badge */}
        {isTrending && (
          <div className="absolute top-2 left-2 z-20 flex items-center gap-1 px-2 py-1 rounded-full bg-gradient-to-r from-[#D1FD0A] to-[#B8E008] text-black text-[10px] font-bold uppercase tracking-wide shadow-lg animate-pulse">
