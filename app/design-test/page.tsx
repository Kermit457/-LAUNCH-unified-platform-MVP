...
export default function DesignTestPage() {
  ...
  const fabActions = [
    { icon: Rocket, label: 'New Launch', onClick: () => console.log('New Launch') },
    { icon: Gift, label: 'Create Bounty', onClick: () => console.log('Create Bounty') },
    { icon: Network, label: 'Invite Friends', onClick: () => console.log('Invite') },
  ];
